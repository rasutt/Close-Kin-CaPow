    ...
    mainPanel(
      tabsetPanel(
        ...
        tabPanel(
          ...
          h4("Kin-pair probability bias - Whole population"),
          ...
          h4("Kin-pair probability errors - Whole population"),
          ...
          h4("Same-mother pairs in final year between animals born in final year
             and each other year in population history"),
          tableOutput(outputId = "SMPsFYear"),
