...
$$= \sum_{b_1 < t}\sum_{b_1 < b_2 \le t} E(N_t)\left(1 - \frac{\phi}{\lambda}\right)\left(\frac{\phi^2}{\lambda}\right)^{t - b_1}\beta$$
$$= E(N_t)\left(1 - \frac{\phi}{\lambda}\right) \beta \sum_{b_1 < t}\sum_{b_1 < b_2 \le t}\left(\frac{\phi^2}{\lambda}\right)^{t - b_1}$$
$$= E(N_t)\left(1 - \frac{\phi}{\lambda}\right) \beta \sum_{b_1 < t}(t - b_1)\left(\frac{\phi^2}{\lambda}\right)^{t - b_1}$$
$$= E(N_t)\left(1 - \frac{\phi}{\lambda}\right) \beta \left\{\frac{\phi^2}{\lambda} + 2\left(\frac{\phi^2}{\lambda}\right)^2 + 3\left(\frac{\phi^2}{\lambda}\right)^3 + ...\right\},$$
...
$$= \frac{r}{(1 - r)^2},$$
and
$$E(SMP_t) = E(N_t)\left(1 - \frac{\phi}{\lambda}\right) \beta \frac{\frac{\phi^2}{\lambda}}{\left( 1 - \frac{\phi^2}{\lambda} \right)^2}$$
because 
$$0 \le S_t \le N_{t + 1},$$
...
as $0 < \phi < 1$,
$$= E(N_t)\left(1 - \frac{\phi}{\lambda}\right) \beta \frac{\lambda\phi^2}{\left(\lambda - \phi^2\right)^2}.$$
