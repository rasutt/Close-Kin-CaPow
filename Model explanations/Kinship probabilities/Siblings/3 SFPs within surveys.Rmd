...
$$\sum_{b \le t} E(SFP_{t, b}) = \frac{\beta^2 \phi^{\alpha + 1}}{4}  \left\{\frac{E(N_t)}{\lambda^{\alpha}} \frac{\lambda}{\lambda - \phi^2} - \frac{1}{1 - \phi^2}\right\}$$
$$E(SFP_t) = \phi E(SMP_t) + \frac{\beta^2 \phi^{\alpha + 1}}{4}  \left\{\frac{E(N_t)}{\lambda^{\alpha}} \frac{\lambda}{\lambda - \phi^2} - \frac{1}{1 - \phi^2}\right\}$$
