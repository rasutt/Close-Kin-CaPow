...
$$= \sum_{b_1 \le t_1} \sum_{t_1 < b_2 \le t_2} E(B_{b_1}) \beta \phi^{t_1 + t_2 - 2 b_1}$$
$$= \sum_{b_1 \le t_1} \sum_{t_1 < b_2 \le t_2} E(N_{b_1})\left(1 - \frac{\phi}{\lambda}\right) \beta \phi^{t_1 + t_2 - 2 b_1}$$
$$= \sum_{b_1 \le t_1} \sum_{t_1 < b_2 \le t_2} \frac{E(N_{t_2})} {\lambda^{t_2 - b_1}} \left(1 - \frac{\phi}{\lambda}\right) \beta \phi^{t_1 + t_2 - 2 b_1}$$
$$= \frac{E(N_{t_2})} {\lambda^{t_2}} \left(1 - \frac{\phi}{\lambda}\right) \beta \phi^{t_1 + t_2} \sum_{b_1 \le t_1} \sum_{t_1 < b_2 \le t_2} \frac{\phi^{-2 b_1}} {\lambda^{-b_1}}$$
