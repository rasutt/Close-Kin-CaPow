...
Then
$$SMP_{t_1, t_2} = \sum_{b_1 < t_1}\sum_{b_1 < b_2 \le t_2}SMP_{t_1, t_2, b_1, b_2},$$
$$E(SMP_{t_1, t_2}) = \sum_{b_1 < t_1}\sum_{b_1 < b_2 \le t_2}E(SMP_{t_1, t_2, b_1, b_2}),$$
$$= \sum_{b_1 < t_1}\sum_{b_1 < b_2 \le t_2}E(SMP_{t_1, b_1, b_2}) \phi^{t_2 - t_1},$$
$$= \sum_{b_1 < t_1}\sum_{b_1 < b_2 \le t_2} 2E(N_{t_1})\left(1 - \frac{\phi}{\lambda}\right)^2\left(\frac{\lambda}{\phi}\right)^\alpha\left(\frac{\phi^2}{\lambda}\right)^{t_1 - b_1} \phi^{t_2 - t_1}$$
$$= 2 E(N_{t_1}) \left(1 - \frac{\phi}{\lambda}\right)^2 \left(\frac{\lambda}{\phi}\right)^\alpha \phi^{t_2 - t_1} \sum_{b_1 < t_1}\sum_{b_1 < b_2 \le t_2} \left(\frac{\phi^2}{\lambda}\right)^{t_1 - b_1}$$
$$\sum_{b_1 < t_1}\sum_{b_1 < b_2 \le t_2} \left(\frac{\phi^2}{\lambda}\right)^{t_1 - b_1} = \frac{\phi^2}{\lambda} (t_2 - t_1 + 1) + \left(\frac{\phi^2}{\lambda}\right)^2 (t_2 - t_1 + 2) + \left(\frac{\phi^2}{\lambda}\right)^3 (t_2 - t_1 + 3) + ...$$
$$= \frac{1}{1 - \frac{\phi^2}{\lambda}} \left\{ \frac{\phi^2}{\lambda} (t_2 - t_1 + 1) + \left(\frac{\phi^2}{\lambda}\right)^2 + \left(\frac{\phi^2}{\lambda}\right)^3 + ... \right\}$$
$$= \frac{\lambda}{\lambda - \phi^2} \left\{ \frac{\phi^2}{\lambda} (t_2 - t_1) + \frac{\phi^2}{\lambda} + \left(\frac{\phi^2}{\lambda}\right)^2 + \left(\frac{\phi^2}{\lambda}\right)^3 + ... \right\}$$
$$= \frac{\lambda}{\lambda - \phi^2} \left\{ \frac{\phi^2}{\lambda} (t_2 - t_1) + \frac{\frac{\phi^2}{\lambda}}{1 - \frac{\phi^2}{\lambda}} \right\}$$
$$= \frac{\lambda}{\lambda - \phi^2} \left\{ \frac{\phi^2}{\lambda} (t_2 - t_1) + \frac{\phi^2}{\lambda - \phi^2} \right\}$$
$$= \frac{\phi^2}{\lambda - \phi^2} \left(t_2 - t_1 + \frac{\lambda}{\lambda - \phi^2} \right)$$
$$E(SMP_{t_1, t_2}) = 2 E(N_{t_1}) \left(1 - \frac{\phi}{\lambda}\right)^2 \left(\frac{\lambda}{\phi}\right)^\alpha \phi^{t_2 - t_1} \frac{\phi^2}{\lambda - \phi^2} \left(t_2 - t_1 + \frac{\lambda}{\lambda - \phi^2} \right)$$
$$= E(SMP_{t_1}) \phi^{t_2 - t_1} \left\{\frac{\lambda - \phi^2}{\lambda} (t_2 - t_1) + 1 \right\}$$
